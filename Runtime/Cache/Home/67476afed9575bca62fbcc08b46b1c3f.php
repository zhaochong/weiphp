        	...
        	<ul id="tab" class="tab-pane in">
            	 <li class="form-item cf">
                  ...
                  <label class="item-label">
                                投票类型 <span class="check-tips">
                                </span></label>
                  
                  <div class="controls">
                      <div class="check-item">
                              <input type="radio" name="select_type" value="0" class="regular-radio" id="select_type_1" checked=""><label for="select_type_1"> </label>单选
                           </div>
                           <div class="check-item">   
                              <input type="radio" name="select_type" value="1" class="regular-radio" id="select_type_2"  ><label for="select_type_2"> </label>双选
