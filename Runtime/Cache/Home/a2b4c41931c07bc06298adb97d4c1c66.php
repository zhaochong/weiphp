  ...
  <div class="span9 page_message">
    <section id="contents">
      <ul class="tab-nav nav">
        <li class=""><a href="<?php echo U('lists');?>">调研列表<b class="arrow fa fa-sort"></b></a></li>
        <li class="current"><a href="javascript:;">新增调研活动<b class="arrow fa fa-sort"></b></a></li>
      </ul>
        ...
        <form id="form" action="<?php echo ($post_url); ?>" method="post" class="form-horizontal form-center">
            	 <div class="form-item cf">
                  ...
                  <div class="form-item cf">
                    ...
                    <div class="controls">
                       <input type="datetime" name="start_time" class="text time" value="<?php echo (time_format($data["start_time"])); ?>" placeholder="请选择时间" /> - 
                       <input type="datetime" name="end_time" class="text time" value="<?php echo (time_format($data["end_time"])); ?>" placeholder="请选择时间" />
                    </div>
                  </div>   
                  ...
                  <div class="form-item cf">
                    ...
                    <div class="controls">
                      ...
                      <textarea class="text input-large" name="intro" style="width:405px; height:150px;"><?php echo ($data["intro"]); ?></textarea>
                      </label>
                    </div>
                  </div>   
                  ...
                  <div class="form-item cf">
                  		<label class="item-label"><span class="need_flag"></span>调研结束说明<span class="check-tips">（为空默认为：调研完成，谢谢参与）</span></label> 
                        <div class="controls">
                            <input type="text" class="text input-large" name="finish_tip" value="<?php echo ($data["finish_tip"]); ?>">
                        </div>
                  </div>
<div class="form-item cf">
        <label class="item-label"><span class="need_flag">*</span>问题管理<span class="check-tips"> </span></label>
        <div style="margin:15px 0;" class="specTable data-table">
          <table cellspacing="1" cellpadding="0">
            <thead>
              <tr>
                <th align="center">问题名称</th>
...
<!--                    <option value="string" <?php if(($cd[type]) == "string"): ?>selected<?php endif; ?> >单行输入 </option>-->
                    <option value="textarea" <?php if(($cd[type]) == "textarea"): ?>selected<?php endif; ?> >简答题 </option>
                    <option value="radio" <?php if(($cd[type]) == "radio"): ?>selected<?php endif; ?> >单选题 </option>
                    <option value="checkbox" <?php if(($cd[type]) == "checkbox"): ?>selected<?php endif; ?> >多选题 </option>
<!--                    <option value="select" <?php if(($cd[type]) == "select"): ?>selected<?php endif; ?> >下拉选择 </option>
              ...
              <tr class="more_tr">
                <td colspan="5"><a href="javascript:add_tr()">+增加新问题</a></td>
              </tr>
            </tbody>
          </table>
        </div>
...
<div id="default_more_html" style="display:none">
      <div class="form-item cf">
        <label class="item-label">默认值<span class="check-tips"> （问题的默认值） </span></label>
        <div class="controls">
          <input type="text" value="[value]" name="value" id="open_value" class="text input-large">
        </div>
      </div>
      <div class="form-item cf">
        <label class="item-label">问题备注<span class="check-tips"> （用于微预约中的提示） </span></label>
        <div class="controls">
