    	...
    	<div class="address_list">
        	<ul>
             <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                	<a class="address_item" href="<?php echo U('confirm_order',array('address_id'=>$vo['id']));?>" title="选择">
                    	<em class="radio_icon">&nbsp;</em>
                    	<p><?php echo ($vo["city_name"]); ?> <?php echo ($vo["address"]); ?></p>
                        <p><b><?php echo ($vo["truename"]); ?></b>  <?php echo ($vo["mobile"]); ?></p>
                    </a>
                    <a class="write_icon" href="<?php echo U('add_address',array('id'=>$vo['id']));?>" title="编辑">&nbsp;</a>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <a class="add_address" href="<?php echo addons_url('Shop://Wap/add_address', array('from'=>1));?>"><em class="add_icon">&nbsp;</em>新增收货地址<em class="arrow_right">&nbsp;</em></a>
        </div>
    </div>	
</body>
</html>